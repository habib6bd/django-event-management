...
from events.views import event_list, event_update, event_delete, total_participants, filter_events, dashboard, event_detail,  event_create, rsvped_events, rsvp_event
